...
class FullScreenApp:
    def __init__(self, master):
        ...
        # Add a label to the left bottom corner of the screen
        self.create_label()
    ...
    def create_buttons(self):
        ...
        for i, text in enumerate(button_texts):
            button = tk.Button(self.master, text=text, bg="#4CAF50", fg="white", font=("Arial", 16), width=7, height=1)
            button.place(x=self.master.winfo_screenwidth() - 116, y=self.master.winfo_screenheight() - 65 - i * 55)

    def create_label(self):
        label_text = "Left Bottom Label"
        label = tk.Label(self.master, text=label_text, bg="black", fg="white", font=("Arial", 16), width=101, height=6)
        label.place(x=17, y=self.master.winfo_screenheight() - 170)
